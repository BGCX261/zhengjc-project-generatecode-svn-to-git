 ...
 */
public class ConfigEditFrame extends javax.swing.JFrame {
     ...
     */
    public ConfigEditFrame() {
         configMap = CommonSession.getConfigMap();
        initComponents();
...
//        this.dispatchEvent(new WindowEvent(this,WindowEvent.WINDOW_CLOSING) );
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel( new javax.swing.DefaultComboBoxModel( configMap.keySet().toArray() ) );
        ...
        jTextField1.setText(configMap.get(key));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = " update config set [value] = '"+val+"' where [key] = '"+key+"'";
        cs.update( sql );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfigEditFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new ConfigEditFrame().setVisible(true);
                }catch (Exception ex) {
                    Logger.getLogger(ConfigEditFrame.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
