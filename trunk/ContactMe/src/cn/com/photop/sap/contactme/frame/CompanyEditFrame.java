 ...
 */
public class CompanyEditFrame extends javax.swing.JFrame {
     ...
     */
    public CompanyEditFrame(MainJFrame mainJFrame) {
...
//        this.dispatchEvent(new WindowEvent(this,WindowEvent.WINDOW_CLOSING) );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        for (Company c : listCompany) {
            if (c.getCompany().equalsIgnoreCase(dname)) {
                message = "公司已经存在";
                javax.swing.JOptionPane.showConfirmDialog((java.awt.Component) null,
                        message, "提示", javax.swing.JOptionPane.DEFAULT_OPTION);
                return;
        ...
        //就公司新名称 dname
        company.setCompany(dname);
        CompanyService companyService = new CompanyService();
        companyService.update(company);
        //修改公司对应的部门信息
        DepartmentService departmentService = new DepartmentService();
        String sql = " update department set [company] = '" + dname + "' where [company] = '" + name + "'";
        departmentService.update( sql );
        //修改公司对应的人员信息
        ContactInfoService contactInfoService = new ContactInfoService();
        // 更新ContactInfo的信息
        sql = " update contactInfo set [company] = '" + dname + "' where [company] = '" + name + "'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CompanyEditFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new CompanyEditFrame(new MainJFrame()).setVisible(true);
                } catch (FileNotFoundException ex) {
                    Logger.getLogger(CompanyEditFrame.class.getName()).log(Level.SEVERE, null, ex);
