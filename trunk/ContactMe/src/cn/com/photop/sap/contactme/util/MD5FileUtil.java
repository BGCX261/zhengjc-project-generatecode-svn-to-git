 ...
 */
/**
 * @project ContactMe @Title: MD5FileUtil @Package
 * cn.com.photop.sap.contactme.util
 *
 * @author Jiancheng.Zheng @email dahaha@189.cn @date 2014-5-12 8:51:54
...
/**
 * @ClassName: MD5FileUtil @Description: TODO(这里用一句话描述这个类的作用)
 *
 * @author Jiancheng.Zheng @email dahaha@189.cn @date 2014-5-12 8:51:54
 * 
*
...
//        String md5 = getFileMD5String(big);
        String md5 = getMD5String( "zhengjc" );
