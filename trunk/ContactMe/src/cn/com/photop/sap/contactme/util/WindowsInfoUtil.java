 ...
 */
/**
 * @project ContactMe @Title: WindowsInfoUtil @Package
 * cn.com.photop.sap.contactme.util
 *
 * @author Jiancheng.Zheng @email dahaha@189.cn @date 2014-5-9 13:04:27
...
/**
 * @ClassName: WindowsInfoUtil @Description: 获取windows系统信息（CPU,内存,文件系统）
 *
 * @author Jiancheng.Zheng @email dahaha@189.cn @date 2014-5-9 13:04:27
 * 
*
...
public class WindowsInfoUtil {
    ...
    public static String cpuSerial() {
        ...
        try {
            ...
            Logger.getLogger(WindowsInfoUtil.class.getName()).log(Level.SEVERE, null, ex);
        }
         return serial;
    }
    ...
    public static void main(String[] args) throws IOException {
        System.out.println(WindowsInfoUtil.getCpuRatioForWindows());
        System.out.println(WindowsInfoUtil.getMemery());
        System.out.println(WindowsInfoUtil.getDisk());
